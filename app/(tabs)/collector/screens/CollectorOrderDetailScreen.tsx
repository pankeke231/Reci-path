...
interface InfoBlockProps {
  label: string;
  value?: string | number; // El signo ? significa que es opcional
  children?: React.ReactNode; // ReactNode es el tipo estándar para elementos hijos en React
}

function InfoBlock({ label, value, children }: InfoBlockProps) {
  return (
