...
import { CITIZEN_BADGE } from "../../../../constants/citizen";
import {
...
export default function ActiveOrderCard({ order, onPress }: { order: CollectionOrder; onPress: () => void }) {
  const badge = (CITIZEN_BADGE as Record<string, { label: string; tone: string }>)[order.status] ?? CITIZEN_BADGE.pending;
