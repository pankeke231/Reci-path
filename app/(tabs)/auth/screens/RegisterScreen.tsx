...
interface Navigation { navigate: (route: string, params?: Record<string, unknown>) => void; goBack: () => void }
interface InputFieldProps {
  label: string; icon: ComponentProps<typeof Ionicons>["name"]; placeholder: string;
  value: string; onChangeText: (text: string) => void; keyboardType?: ComponentProps<typeof TextInput>["keyboardType"];
  secureTextEntry?: boolean; autoCapitalize?: ComponentProps<typeof TextInput>["autoCapitalize"];
...
export default function RegisterScreen({ navigation }: { navigation: Navigation }) {
