 ...
 * @param {UserProfile|null|undefined} profile
 */
export function getProfileFirstName(profile: UserProfile | null | undefined): string {
 ...
 * @param {UserProfile|null|undefined} profile
 */
export function isCollector(profile: UserProfile | null | undefined): boolean {
 ...
 * @param {UserProfile|null|undefined} profile
 */
export function isCitizen(profile: UserProfile | null | undefined): boolean {
