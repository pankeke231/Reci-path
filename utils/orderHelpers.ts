 ...
 */
export function encodeOrderNotes(pickupDate: string, description: string): string | null {
 ...
 */
export function parseOrderNotes(notes: string | null | undefined): { pickupDate: string | null; description: string } {
 ...
 */
export function filterActiveOrders(orders: CollectionOrder[]): CollectionOrder[] {
 ...
 * @param {import('../../../models/order').CollectionOrder[]} orders
 */
export function calculateWeeklyCo2Saved(orders: CollectionOrder[]): number {
 ...
 * @param {import('../../../models/order').CollectionOrder[]} orders
 */
export function hasActiveRequests(orders: CollectionOrder[]): boolean {
 ...
 */
export function estimatePoints(quantityKg: number): number {
 ...
 */
export function formatHistorySchedule(date: string | Date | null | undefined): string {
  if (!date) return "—";
 ...
 * @param {string|Date} date
 */
export function formatCompletedHeader(date: string | Date | null | undefined): string {
 ...
 * @param {import('../../../models/order').CollectionOrder} order
 */
export function getRecyclerLabel(order: CollectionOrder): string {
